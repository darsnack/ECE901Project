...
wire signed [(WL - 1):0] layer_1_final_error_patch [0:(PATCH_LENGTH - 1)];
...
always @(CurrentState, Start) begin
    ...
    STATE_L1_ERR_DATA: NextState <= STATE_L1_GR_START;
...
always @(CurrentState) begin
    ...
    STATE_L1_ERR_DATA: begin
        ...
        for (i = 0; i < LAYER_1_DEPTH; i = i + 1) begin
            for (j = 0; j < LAYER_2_HEIGHT; j = j + 1) begin
                for (k = 0; k < LAYER_2_WIDTH; k = k + 1) begin
                    layer_1_error[i * (LAYER_2_WIDTH * LAYER_2_HEIGHT) + (2 * j) * LAYER_1_WIDTH + k * 2]
                        <= layer_3_error[i * (LAYER_2_WIDTH * LAYER_2_HEIGHT) + j * LAYER_2_WIDTH + k];
                    layer_1_error[i * (LAYER_2_WIDTH * LAYER_2_HEIGHT) + (2 * j + 1) * LAYER_1_WIDTH + k * 2]
                        <= layer_3_error[i * (LAYER_2_WIDTH * LAYER_2_HEIGHT) + j * LAYER_2_WIDTH + k];
                    layer_1_error[i * (LAYER_2_WIDTH * LAYER_2_HEIGHT) + (2 * j) * LAYER_1_WIDTH + k * 2 + 1]
                        <= layer_3_error[i * (LAYER_2_WIDTH * LAYER_2_HEIGHT) + j * LAYER_2_WIDTH + k];
                    layer_1_error[i * (LAYER_2_WIDTH * LAYER_2_HEIGHT) + (2 * j + 1) * LAYER_1_WIDTH + k * 2 + 1]
                        <= layer_3_error[i * (LAYER_2_WIDTH * LAYER_2_HEIGHT) + j * LAYER_2_WIDTH + k];
                end
            end
        end
    ...
    STATE_L1_GR_DATA: begin
        for (i = 0; i < LAYER_1_DEPTH; i = i + 1) begin
            ...
            in1_layer_1[i * PATCH_LENGTH + 7] <= in8;
            in1_layer_1[i * PATCH_LENGTH + 8] <= in9;
            in2_layer_1[i * PATCH_LENGTH + 0] <= layer_1_final_error_patch[0];
            in2_layer_1[i * PATCH_LENGTH + 1] <= layer_1_final_error_patch[1];
            in2_layer_1[i * PATCH_LENGTH + 2] <= layer_1_final_error_patch[2];
            in2_layer_1[i * PATCH_LENGTH + 3] <= layer_1_final_error_patch[3];
            in2_layer_1[i * PATCH_LENGTH + 4] <= layer_1_final_error_patch[4];
            in2_layer_1[i * PATCH_LENGTH + 5] <= layer_1_final_error_patch[5];
            in2_layer_1[i * PATCH_LENGTH + 6] <= layer_1_final_error_patch[6];
            in2_layer_1[i * PATCH_LENGTH + 7] <= layer_1_final_error_patch[7];
            in2_layer_1[i * PATCH_LENGTH + 8] <= layer_1_final_error_patch[8];
        end
...
stochastic_quantizer #(.WL(WL), .FL(FL)) layer_1_error_quantizer1(
	.CLK(CLK),
	.RESET(RESET),
	.in(layer_1_error[i * (LAYER_1_WIDTH * LAYER_1_HEIGHT) + (layer_1_gr_row - 1) * LAYER_2_WIDTH + layer_1_gr_col - 1]),
	.out(layer_1_final_error_patch[0]),
	.overflow()
);

stochastic_quantizer #(.WL(WL), .FL(FL)) layer_1_error_quantizer2(
	.CLK(CLK),
	.RESET(RESET),
	.in(layer_1_error[i * (LAYER_1_WIDTH * LAYER_1_HEIGHT) + (layer_1_gr_row - 1) * LAYER_2_WIDTH + layer_1_gr_col]),
	.out(layer_1_final_error_patch[1]),
	.overflow()
);

stochastic_quantizer #(.WL(WL), .FL(FL)) layer_1_error_quantizer3(
	.CLK(CLK),
	.RESET(RESET),
	.in(layer_1_error[i * (LAYER_1_WIDTH * LAYER_1_HEIGHT) + (layer_1_gr_row - 1) * LAYER_2_WIDTH + layer_1_gr_col + 1]),
	.out(layer_1_final_error_patch[2]),
	.overflow()
);

stochastic_quantizer #(.WL(WL), .FL(FL)) layer_1_error_quantizer4(
	.CLK(CLK),
	.RESET(RESET),
	.in(layer_1_error[i * (LAYER_1_WIDTH * LAYER_1_HEIGHT) + layer_1_gr_row * LAYER_2_WIDTH + layer_1_gr_col - 1]),
	.out(layer_1_final_error_patch[3]),
	.overflow()
);

stochastic_quantizer #(.WL(WL), .FL(FL)) layer_1_error_quantizer5(
	.CLK(CLK),
	.RESET(RESET),
	.in(layer_1_error[i * (LAYER_1_WIDTH * LAYER_1_HEIGHT) + layer_1_gr_row * LAYER_2_WIDTH + layer_1_gr_col]),
	.out(layer_1_final_error_patch[4]),
	.overflow()
);

stochastic_quantizer #(.WL(WL), .FL(FL)) layer_1_error_quantizer6(
	.CLK(CLK),
	.RESET(RESET),
	.in(layer_1_error[i * (LAYER_1_WIDTH * LAYER_1_HEIGHT) + layer_1_gr_row * LAYER_2_WIDTH + layer_1_gr_col + 1]),
	.out(layer_1_final_error_patch[5]),
	.overflow()
);

stochastic_quantizer #(.WL(WL), .FL(FL)) layer_1_error_quantizer7(
	.CLK(CLK),
	.RESET(RESET),
	.in(layer_1_error[i * (LAYER_1_WIDTH * LAYER_1_HEIGHT) + (layer_1_gr_row + 1) * LAYER_2_WIDTH + layer_1_gr_col - 1]),
	.out(layer_1_final_error_patch[6]),
	.overflow()
);

stochastic_quantizer #(.WL(WL), .FL(FL)) layer_1_error_quantizer8(
	.CLK(CLK),
	.RESET(RESET),
	.in(layer_1_error[i * (LAYER_1_WIDTH * LAYER_1_HEIGHT) + (layer_1_gr_row + 1) * LAYER_2_WIDTH + layer_1_gr_col]),
	.out(layer_1_final_error_patch[7]),
	.overflow()
);

stochastic_quantizer #(.WL(WL), .FL(FL)) layer_1_error_quantizer9(
	.CLK(CLK),
	.RESET(RESET),
	.in(layer_1_error[i * (LAYER_1_WIDTH * LAYER_1_HEIGHT) + (layer_1_gr_row + 1) * LAYER_2_WIDTH + layer_1_gr_col + 1]),
	.out(layer_1_final_error_patch[8]),
	.overflow()
);
